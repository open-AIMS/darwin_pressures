...
units_lookup <- tribble(
    ~Measure,     ~Units,         ~TableLabel,                            ~FigureLabel,
    "Chla",       "mu.g/L",       "Chlorophyll-a (µg/L)",                 "Chlorophyll-a~(mu*g/L)",
    "Turbidity",  "NTU",          "Turbidity (NTU)",                      "Turbidity~(NTU)",
    "DO",         "% saturation", "Dissolved Oxygen (% Saturation)",      "Dissolved~Oxygen~('%'~Saturation)",
    "NH3",        "mu.g/L",       "Ammonia (µg/L)",                       "Ammonia~(mu*g/L)",
    "PO4",        "mu.g/L",       "Filterable Reactive Phosphate (µg/L)", "Filterable~Reactive~Phosphate~(mu*g/L)",
    "NOx",        "mu.g/L",       "NOx as N (µg/L)",                      "Nox~as~N~(mu*g/L)",
    "TotalN",     "t",            "Total N (t)",                          "Total~N~(t)",
    "TotalP",     "t",            "Total P (t)",                          "Total~P~(t)",
    "Discharge",  "kL",           "Discharge volume (annual kL)",         "Discharge~volume~(kL)",
    "TSS",        "t",            "Total suspended solids (t)",           "Total~suspended~solids~(t)",
    "VSS",        "t",            "Volatile suspended solids (t)",           "Volatile~suspended~solids~(t)",
    "ERP",        "",             "Estimated resident population",        "Estimated~resident~population",
    "ERP_growth", "",             "Estimated resident population growth", "Estimated~resident~population~growth",
    ...
    "Rainfall_anom","(mm)",       "Rainfall anomaly (mm)",               "Rainfall~anomaly~(mm)",
    "AirTemp",    "(oC)",         "Mean air temperature (oC)",           "Mean~air~temperature~(degree*C)",
    "AirTemp_anom","(oC)",        "Mean air temperature anomaly (oC)",   "Mean~air~temperature~anomaly~(degree*C)",
    "SOI",        "",             "Southern Oscillation Index",          "Southern~Oscillation~Index",
    "SST_anom",   "",             "Sea Surface Temperature anomaly",     "Sea~Surface~Temperature~anomaly",
    "Building_total","($B)",      "Total building activity ($B)",        "Total~building~activity~($B)",
    "Building_eng","($B)",        "Engineering building activity ($B)",  "Engineering~building~activity~($B)",
    "Building_non","($B)",        "Non-residential building activity ($B)",  "Non-residential~building~activity~($B)",
    "Building_res","($B)",        "Residential building activity ($B)",  "Residential~building~activity~($B)",
    "Ship_trade","",          "Number of trade ships",               "Number~of~trade~ships",
    "Ship_cont", "",          "Number of container ships",           "Number~of~container~ships",
    "Ship_liq", "",          "Number of liquid bulk ships",           "Number~of~liquid~bulk~ships",
    "Ship_car", "",          "Number of car carrier ships",           "Number~of~car~carrier~ships",
    "Ship_live", "",          "Number of livestock ships",           "Number~of~livestock~ships",
    "Ship_rig", "",          "Number of rig tenders",                "Number~of~rig~tenders",
    "Ship_cruise", "",          "Number of cruise ships",           "Number~of~cruise~ships",
    "Ship_dry", "",          "Number of dry bulk ships",           "Number~of~dry~bulk~ships",
    )
