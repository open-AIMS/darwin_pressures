...
Management) data.  The `Discrete` data are collected via grab samples
and typically are collected at specific locations repeatedly on an
annual schedule. 
...
![Spatio-temporal distribution of sampling locations between 2016 and 2022](../output/figures/map_wq__2016_2022.png){#fig-wq-2016-spatial}

The following are all samples ("CFM" and "Discrete").

![Spatial distribution of sampling locations between 2016 and 2022](../output/figures/map_wq__2016_2022_all.png){#fig-wq-2016-spatial1}
...
Processed the same as the 2016-2022 data.
...
![Spatio-temporal distribution of sampling locations in 2018](../output/figures/map_wq__2018.png){#fig-wq-2018-spatial}

![Spatio-temporal distribution of sampling locations in 2018](../output/figures/map_wq__2018_all.png){#fig-wq-2018_all-spatial}
...
for (i in FOCAL_RESPS) {
    ...
    cat(paste0("\n### ", lab, "\n"))
    cat(paste0("![",cap,"](../output/figures/EDA_routine_",i,".png){#fig-EDA-routine-",i,"} \n\n"))}
```
...
for (j in FOCAL_RESPS) {
    ...
    for (i in 1:nrow(FOCAL_PRESSURES)) {
        ...
        for (k in 0:2) {
            ...
            cat(paste0("![",cap,"](../output/figures/EDA_dual_plot.routine.__",j,"__",MEASURE,k,".png){#fig-EDA-routine-",j,".",MEASURE,k,"} \n\n"))
        }
    ...
    for (i in 1:nrow(FOCAL_PRESSURES)) {
        ...
        for (k in 0:2) {
            ...
            cap <- paste0("Temporal trends (lag = ",k,") in ",lab,
                          ...
                          "Points represent collected observations at unique lat/long/Year combinations.  Each individual point is 80% transparent, and thus darker points represent a greater quantity of observations with similar values. Faint lines join sets of observations collected at the same lat/long over time.  Solid lines represent simple Generalized Additive Modeling splines with 95% confidence envelopes.  Note, these are purely simple models that do not take into account any dependency structures (e.g. do not include random effects or autoregressive terms).")
            if (k == 0) k = ""
            else k = paste0("_lag",k,".",k)
            cat(paste0("![",cap,"](../output/figures/gamPlots.__",j,"__",MEASURE,k,".png){#fig-EDA-",j,".",MEASURE,k,"} \n\n"))
        ...
        for (k in 0:2) {
            cat(paste0("\n##### Lag ", k, "\n"))
            if (k == 0) k = ""
            else k = paste0("_lag.",k)
            #cat(paste0("![",cap,"](../output/figures/partial__",j,"__",MEASURE,k,".png){#fig-EDA-",j,".",MEASURE,k,"} \n\n"))
            #cat(paste0("\n#### DHARMa residual uniformity\n"))
            #cat(paste0("![",cap,"](../output/figures/DHARMa_unif__",j,"__",MEASURE,k,".png){#fig-EDA-",j,".",MEASURE,k,"} \n\n"))
            #cat(paste0("\n#### DHARMa residual quantiles\n"))
            #cat(paste0("![",cap,"](../output/figures/DHARMa_quant__",j,"__",MEASURE,k,".png){#fig-EDA-",j,".",MEASURE,k,"} \n\n"))
        }
